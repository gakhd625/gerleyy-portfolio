...
export default function WorkExperience() {
  return (
    <section id="experience" className="mb-24 scroll-mt-8">
      <h2 className="text-3xl font-bold mb-8 text-black dark:text-white">Work Experience</h2>
        ...
        {portfolioData.workExperience.map((exp, index) => (
          ...
          >
            ...
            <div className="flex-1">
              <h3 className="text-xl font-semibold mb-1 text-black dark:text-white">{exp.company}</h3>
