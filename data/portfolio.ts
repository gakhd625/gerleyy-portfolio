...
export const portfolioData = {
  ...
  about: "I’m a full-stack software engineer specializing in building scalable, production-ready web and application systems using Next.js, Python, and Laravel. I develop modern web applications, mobile solutions, and platform features with a strong focus on performance, clean architecture, and maintainable code. I accelerate projects from concept to deployment, turning ideas into functional products while ensuring real-world usability and business value. My workflow emphasizes rapid iteration, efficient problem-solving, and delivering reliable software in fast-paced environments. In addition to development, I’m actively expanding my expertise in cloud security and AI-driven security practices. I explore how artificial intelligence can improve threat detection, automate security processes, and support secure-by-design systems. My goal is to build high-performance applications that are scalable, resilient, and secure.",
